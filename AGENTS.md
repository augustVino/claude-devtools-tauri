...
This project is indexed by GitNexus as **claude-devtools-tauri** (8854 symbols, 16833 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
